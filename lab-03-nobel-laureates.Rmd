...
There are `r nrow(nobel)` observations and `r ncol(nobel)` variables in the dataset. Each row represents a Nobel laureate.
...
There are `r us_born_count` winners who were born in the US.
...
The most common birth country for immigrant Nobel laureates who won their prize while in the US is `r immigrant_nobelists$born_country[1]`.
